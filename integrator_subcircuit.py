...
circuit.B('1', 'measured', circuit.gnd, voltage_expression='I(component)')



        self.raw_spice += f"""
A2 measured i_out i_model
...
circuit.B('2', circuit.gnd, circuit.gnd, current_expression='V(i_out)')
